...
public class CommentAdapter
    ...
    public void onBindViewHolder(CommentViewHolder holder, int position) {
        ...
        Comment thisComment = comments.get(position);   //object of Comment class
        //this object is initialised by the object stored at index=positions inside the Arraylist called comments.
